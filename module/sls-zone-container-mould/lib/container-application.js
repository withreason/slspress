...
const Application = require('sls-zone-mould').Application;
const Middleware = require('sls-zone-mould').Middleware;
...
const ContainerMiddlewareApplicator = require('./container-middleware-applicator');
...
class ContainerApplication extends Application {
  ...
  constructor(environment) {
    ...
    super((errorHandler, responseFactory) => new ContainerMiddlewareApplicator(errorHandler, responseFactory, createContainer));
